...
const Submenu = () => (
  <ul className="submenu dropdown-menu bg-white">
    ...
    <li>
      <a href="#">cpntent marketing</a>
    </li>
  </ul>
);
const Navbar = () => {
  // const [isProduct3Open, setProduct3Open] = useState(false);

  // const handleProduct3Hover = () => {
  //   setProduct3Open(true);
  // };

  // const handleProduct3Leave = () => {
  //   setProduct3Open(false);
  // };
                ...
                <ul className="nav-item">
                  ...
                  >
                    ...
                    <div className="dropdown-menu bg-white ">
                      ...
                      >
                        <a href="#">Product 3 &raquo;</a>
                        {isProduct3SubMenuOpen && <Submenu />}
                      </li>
                    </div>
                  </li>
